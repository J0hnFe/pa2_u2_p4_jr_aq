...
public class Pa2U2P4JrAqApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Estudiante estudianteNMQ = this.estudianteService.buscarPorApellidoNamedQuery("Ramos");
		System.out.println("Estu NQ encontrado = " + estudianteNMQ);
		
		Estudiante estudianteN = this.estudianteService.buscarPorApellidoNamed("Ramos");
		System.out.println("estu named encontrado = " + estudianteN);
		
		Estudiante estudianteNati= this.estudianteService.buscarPorApellidoNativeQuery("Ramos");
		System.out.println("Estudiante native " + estudianteNati);
		
		Estudiante estudianteNNQ=this.estudianteService.buscarPorApellidoNativeQueryNamed("Ramos");
		System.out.println(estudianteNNQ);
		
		Estudiante estudianteNatiNom=this.estudianteService.buscarPorNombreNativeQuery("Felipe");
		System.out.println(estudianteNatiNom);
		
		Estudiante estudianteNatiNamesNom=this.estudianteService.buscarPorNombreNativeQueryNamed("Felipe");
				System.out.println(estudianteNatiNamesNom);
	}
